...
# -*- coding: utf-8 -*-
#
# diffpy.morph documentation build configuration file, created by  # noqa: E501
...
try:
    fullversion = version("diffpy.morph")
except Exception:
...
modindex_common_prefix = ["diffpy.morph"]
...
basename = "diffpy.morph".replace(" ", "").replace(".", "")
